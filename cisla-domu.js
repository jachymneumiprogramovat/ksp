...
var novy = fs.readFileSync("C:/Extrení disk - Lokálně/zalohy/Jachym/kód/ksp2021/cisla-domu/05.in").toString()
novy.toString()
novy = novy.split("\n")
novy.shift()
novy.pop()
...
let stary = fs.readFileSync("C:/Extrení disk - Lokálně/zalohy/Jachym/kód/ksp2021/cisla-domu/05.in").toString()
stary.toString()
stary = stary.split("\n")
stary.shift()
stary.pop()
